...
function read_matrix(matrix) {
    for (let element of matrix) {
        // Determine if it is a setosa, versicolor, or virginica flower
...
function compute_averages() {
    ...
    // "Iris-virginica"
    virginica_sepal_Length = (virginica_sepal_Length / setosa_count).toFixed(2);
    virginica_sepal_Width = (virginica_sepal_Width / setosa_count).toFixed(2);
    virginica_petal_Length = (virginica_petal_Length / setosa_count).toFixed(2);
    virginica_petal_Width = (virginica_petal_Width / setosa_count).toFixed(2);
}
...
console.log("Logan Roe");
console.log("lroe@iastate.edu");
console.log("Sep 16, 2024");